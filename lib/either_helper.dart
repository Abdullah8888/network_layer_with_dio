...
/// This code was wriiten by avdosev, https://github.com/avdosev/either_dart/blob/master/lib/src/either.dart
sealed class Either<L, R> {
  const Either();

  /// Represents the left side of [Either] class which by convention is a "Failure".
  bool get hasError => this is Left<L, R>;

  /// Represents the right side of [Either] class which by convention is a "Success"
  bool get hasResponse => this is! Left<L, R>;
